                ...
                <?php if (get_field('consultation_price')) : ?>
                    <div class="d-flex align-items-center mb-2 consultation">
                        <svg width="45" height="46" viewBox="0 0 45 46" fill="none"
                            ...
                            <path d="M19.8965 21.3333L21.3846 23L25.1048 18.8333" stroke="<?php echo $theme_color ?>"
                                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M17.8125 26.6458H27.1875" stroke="<?php echo $theme_color ?>" stroke-width="2"
