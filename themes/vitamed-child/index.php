...
?>
    ...
    <div class="archive-wrapper blog" id="archive-wrapper">
                        ...
                        if (have_posts()) {
                            ...
                            while (have_posts()) {
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="bg-white d-flex flex-row single-item h-100">
                                        ...
                                        <div class="content-wrapper">
                                            <h3 class="title mb-3 "><?php echo esc_html(get_the_title(get_the_ID())); ?><span
                                                        class="text-secondary">.</span></h3>
                                            <?php add_filter('excerpt_length', 'vitamed_custom_excerpt_length', 999); ?>
                                            <div class="content limit-4-lines mb-5"><?php echo get_the_excerpt(get_the_ID()); ?></div>
                            ...
                            <div class=" d-flex flex-wrap justify-content-between ">
                                <?php if ($title || $text) { ?>
                                    <div class="px-2 py-md-3 col-12 col-md-6  col-lg-6 mb-3 mb-md-0 ">
                                        <svg width="50" class="mb-4" height="50" viewBox="0 0 50 50" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <rect width="50" height="50" rx="15" fill="#4CD30E" fill-opacity="0.1"/>
                                            <path d="M22 27.2354V30.0001C22 32.7615 24.2386 35.0001 27 35.0001H27.8824C29.7691 35.0001 31.3595 33.7311 31.8465 32.0001"
                                            ...
                                            <path d="M18.4286 16H18.3369C18.024 16 17.8676 16 17.7357 16.0117C16.2876 16.1397 15.1397 17.2876 15.0117 18.7357C15 18.8676 15 19.024 15 19.3369V20.2353C15 24.1013 18.134 27.2353 22 27.2353C25.7082 27.2353 28.7143 24.2292 28.7143 20.521V19.3369C28.7143 19.024 28.7143 18.8676 28.7026 18.7357C28.5746 17.2876 27.4267 16.1397 25.9785 16.0117C25.8467 16 25.6902 16 25.3774 16H25.2857"
                                                  stroke="#4CD30E" stroke-width="2" stroke-linecap="round"/>
                                            <circle cx="32" cy="29" r="3" stroke="#4CD30E" stroke-width="2"/>
                                            <path d="M25 15V17" stroke="#4CD30E" stroke-width="2"
                                                  stroke-linecap="round"/>
                                            <path d="M19 15V17" stroke="#4CD30E" stroke-width="2"
                                                  stroke-linecap="round"/>
                                        </svg>
                                        <?php if ($title) { ?>
                                            <?php
