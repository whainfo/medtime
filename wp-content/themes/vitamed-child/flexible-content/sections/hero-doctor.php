<?php $theme_color = get_field( 'theme_color', 'option' ) ? get_field( 'theme_color', 'option' )  : '#4CD30E' ;?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
                            ...
                            <?php if ( get_field( 'consultation_price' ) ) : ?>
                                <div class="d-flex align-items-center mb-2 consultation">
                                    <svg width="45" height="46" viewBox="0 0 45 46" fill="none"
                                        ...
                                        <rect y="0.5" width="45" height="45" rx="15" fill="<?php echo $theme_color ?>" fill-opacity="0.1"/>
                                        ...
                                        <path d="M19.8965 21.3333L21.3846 23L25.1048 18.8333"
                                              stroke="<?php echo $theme_color ?>"
                                              stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M17.8125 26.6458H27.1875" stroke="<?php echo $theme_color ?>"
                                              stroke-width="2"
