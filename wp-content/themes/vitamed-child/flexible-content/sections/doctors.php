                ...
                <?php if ( $items ) { ?>
                    <div class="swiper-wrapper">
                        <?php foreach ( $items as  $k=> $p_id ):
                            ...
                            <div class="swiper-slide   doctor-item-wrapper p-0 rounded-0"  data-aos="fade-up"  data-aos-delay="<?php echo $aos_delay; ?>">
                                        ...
                                        <div class="">
                                            ...
                                            <?php if ( $consultation_price ) { ?>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="">
                                                        <svg width="45" height="45" viewBox="0 0 45 45" fill="none" role="img" aria-label="Price"
