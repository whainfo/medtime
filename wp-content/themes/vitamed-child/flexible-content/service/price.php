<?php
$items                = get_field( 'prices' );
?>
<div id="price" class="price-wrapper  wrapper">
    <h2 class="mb-4"><?php echo __( 'Вартість послуг', 'vitamed' ) ?></h2>
            ...
            <?php foreach ( $items as $k => $item ):
                ...
                <div class="accordion-item bg-white rounded-1 overflow-hidden <?php echo $k == 0 ? '' : 'mt-4' ?>"
                    ...
                    <div class="accordion-header "
                        ...
                        <button class="accordion-button collapsed h3 mb-0" type="button" data-bs-toggle="collapse"
